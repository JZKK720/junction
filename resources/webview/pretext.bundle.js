var Pretext = (() => {
  ...
  // pretext-entry.js
  var pretext_entry_exports = {};
  __export(pretext_entry_exports, {
  ...
  // pretext-lib/dist/generated/bidi-data.js
  var latin1BidiTypes = [
    "BN",
    "BN",
    "BN",
  ...
  // pretext-lib/dist/measurement.js
  ...
  // pretext-lib/dist/line-break.js
  ...
  // pretext-lib/dist/rich-inline.js
  ...
  function stepRichInlineLine(flow, maxWidth, cursor, collectFragment) {
    ...
    lineLoop: while (itemIndex < flow.items.length) {
      ...
      if (textCursor.segmentIndex === lineEnd.segmentIndex && textCursor.graphemeIndex === lineEnd.graphemeIndex) {
        itemIndex++;
        textCursor.segmentIndex = 0;
        textCursor.graphemeIndex = 0;
        continue;
  ...
  return __toCommonJS(pretext_entry_exports);
})();
