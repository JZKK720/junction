...
This will create a `.vsix` file in your project root with a name like `junction-0.0.1.vsix` (based on your package.json version).
...
```bash
code --install-extension junction-0.0.1.vsix
```
